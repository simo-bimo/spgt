...
from spgt.names import ASP_PPLTL_PLANNER_PATH, ASP_PLANNER_PATH, ASP_REGRESSOR_PATH, ASP_PPLTL_REGRESSOR_PATH, ASP_CLINGRAPH_PATH
...
def solve_iteratively(instance_file, starting_number: int = 0, generate_graph: bool=False):
	files = [instance_file, ASP_PPLTL_REGRESSOR_PATH, ASP_PPLTL_PLANNER_PATH]
	if generate_graph:
